...
if (is_admin()){
 ...
 /* $my_meta->addText($prefix.'text_field_id',array('name'=> __('My Text ','tax-meta')));
  ...
  //Image field
  $my_meta->addImage($prefix.'cat_image_1',array('name'=> __('Изображение 1 ','tax-meta')));
  $my_meta->addImage($prefix.'cat_image_2',array('name'=> __('Изображение 2 ','tax-meta')));
  $my_meta->addImage($prefix.'cat_banner',array('name'=> __('Баннер','tax-meta')));
  //file upload field
